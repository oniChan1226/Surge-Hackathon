  ...
  return (
    ...
    <div className="py-12 bg-white">
        <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="">
                <h2
                    className="font-heading mb-4 bg-orange-100 text-primary-dark px-4 py-2 rounded-lg md:w-64 lg:text-center md:mx-auto text-xs font-semibold tracking-widest  uppercase title-font">
                    Why choose us?
                </h2>
            ...
            <div className="mt-10">
                <dl className="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
                    <div className="relative bg-gray-100/90 p-3 md:p-5 lg:p-8 rounded-md shadow-lg">
                        <dt>
                            <div
